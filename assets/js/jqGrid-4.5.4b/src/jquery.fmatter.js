...
;(function($) {
	...
	$.fn.fmatter.rowactions = function(rid,gid,act,pos) {
		...
		switch(act)
		{
			...
			case 'formedit':
				...
				break;
			case 'view':
			    $('#'+gid).jqGrid('viewGridRow',rid, op.viewrecords);
			    break;
		}
	};
	$.fn.fmatter.actions = function(cellval,opts, rwd) {
		...
		if(op.viewrecords){
		    ocl = "onclick=$.fn.fmatter.rowactions('"+rowid+"','"+opts.gid+"','view',"+opts.pos+"); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ";
			str =str+ "<div title='"+$.jgrid.nav.viewtitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-search' "+ocl+"><span class='ui-icon ui-icon-search'></span></div>";
		}
		if(op.delbutton) {
