...
<html>
	<head>
		...
		<!-- Load JQuery -->		
		<script type="text/javascript" src="<?=base_url().'assets/js/jquery/jquery.1.5.1.min.js';?>"></script>

		<!-- Load JQuery UI -->
		<script type="text/javascript" src="<?=base_url().'assets/js/jquery/jquery-ui.1.8.min.js';?>"></script>
