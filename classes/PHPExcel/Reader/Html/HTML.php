...
require_once PHPEXCEL_ROOT . 'PHPExcel/Reader/Html/Translator/CssPhpExcelTranslator.php';
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
                        ...
                        if (isset($attributeArray['style']) && !empty($attributeArray['style'])) {
                            ...
                            //print_r($styleAry);
                            //$content = print_r($styleAry,true);                        
                            //verbose_log($content,$type="lib",$path="html_reader");
