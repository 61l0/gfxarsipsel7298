<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		if(row.act == ""){
			var fnView = "<?=$class_name;?>grid.btn_grid_view({id_row:"+cl+",act:'view'});";
			var insView = jQuery("<div />").addClass("ui-pg-div ui-inline-edit").css("float","left").css("cursor","pointer").attr("title","Klik untuk melihat detail data");
			...
			var fnEdit = "<?=$class_name;?>grid.btn_grid_edit({id_row:"+cl+",act:'edit'});";
