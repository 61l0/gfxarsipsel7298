...
class Myexcel_dpa_unit_pengolah extends PHPExcel {
    ...
    function Myexcel_dpa_unit_pengolah()
    {
		parent::__construct();
    }
	...
	function download()
    {
		...
		header('Content-Disposition: attachment;filename="laporan_dpa_unit_pengolah.xls"');
