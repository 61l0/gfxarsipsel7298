...
<tr><td colspan=9 align='center'>LAPORAN DAFTAR PENCARIAN DATA ARSIP->TAHUN ARSIP</td></tr>
...
<tr>
	...
	<form id="myForm" action="<?=site_url('admin/com/lap_pencarian_tahun_arsip');?>/rptklasifikasi/" target="_blank" method="post">
