...
$config['gridlib']['grid']['opt']['caption'] = "Master Kode Pembantu";
$config['gridlib']['grid']['opt']['rowNum'] = 10;
$config['gridlib']['grid']['opt']['rowList'] = array(10,30,50,100);
$config['gridlib']['grid']['opt']['prmNames']['id'] = "id_kode_pembantu";
...
$config['gridlib']['arr_colModel']["id_kode_pembantu"] = array(
	'name'=>"id_kode_pembantu",
	'index'=>"id_kode_pembantu",
	'hidden'=>true,
	'key'=>true,
	'editable'=>true,
	);
...
$config['gridlib']['arr_colModel']["name"] = array(
	'name'=>"name",
	'index'=>"name",
	'label'=>"NAMA KODE PEMBANTU",
	'width'=>200,
	'editable'=>true,
	'edittype'=>'text',
	'editoptions'=>array('size'=>50), 
	'editrules'=>array('required'=>true), 
	'formoptions'=>array('label'=>'<strong>Nama Kode Pembantu(*)</strong>')
	);
