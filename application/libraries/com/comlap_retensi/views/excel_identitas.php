...
<head>
	...
	<meta content='setColumn {"0":5,"1":12,"2":20,"3":50,"4":8,"5":9,"6":9,"7":16,"8":16}'/>
	<meta content='setRow {"0":30,"1":30,"10":20,"11":20}'/>
	...
	<table border="1" align="center" class="tb-excel" cellpadding="4" colspacing="4" style="border-collapse:collapse" width="98%">
		<thead>
			...
			<tr>
				...
				: <?php echo bln_indo($depo_text?strtoupper($depo_text):'ALL')?>
				</th>
			</tr>
			<tr>
			...
			<tr>
				...
				<th colspan="7" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">
				: <?php echo $lokasi?strtoupper($lokasi):'-'?>
				</th>
			</tr>
			<tr>
			...
			<tr>
				<th colspan="2" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">STATUS </th>
				<th colspan="7" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">
				: <?php echo $status?strtoupper($status):'ALL'?>
				</th>
			</tr>
			<tr>
				<th colspan="9" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter"> </th>
