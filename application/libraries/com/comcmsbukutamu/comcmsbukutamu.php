...
class Comcmsbukutamu extends Grid {
	function __construct(){
	    // ===============================
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'admin/com/cmsbukutamu/';
		$params->lib['class_name'] = 'comcmsbukutamu';
		$params->lib['header_caption'] = 'Saran dan Kritik &raquo; Buku Tamu';
		// =========================================================
		...
		$params->gridlib['grid']['opt']['postData']['id_kategori'] = 0;
