<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		var fnNameSv = "<?=$class_name;?>grid.btn_grid_view({id_renstra:'"+cl+"'});";
		...
		var fnName3 = "<?=$class_name;?>grid.btn_grid_edit({id_renstra:"+cl+",oper:'edit'});";
		...
		var fnref = "<?=$class_name;?>grid.extra.refresh({id_renstra:"+cl+"});";
		...
		var fnDel = "<?=$class_name;?>grid.extra.del({id_renstra:"+cl+"});";
