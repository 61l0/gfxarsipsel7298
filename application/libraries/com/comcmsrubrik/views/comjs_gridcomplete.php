<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		var fnNameSv = "<?=$class_name;?>grid.btn_view({id_menu:'"+cl+"'});";
		...
		var fnName3 = "<?=$class_name;?>grid.btn_grid_status({id_menu:"+cl+",oper:'edit'});";
		var sp3 = jQuery("<span />").addClass("ui-icon ui-icon-transferthick-e-w").attr('onclick',fnName3);
		...
		var fnDel = "<?=$class_name;?>grid.extra.del({id_menu:"+cl+",id_group:"+id_group+"});";
