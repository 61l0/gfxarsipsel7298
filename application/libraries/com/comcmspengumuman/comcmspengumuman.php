...
class Comcmspengumuman extends Grid {
	function __construct(){
	    // ===============================
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'admin/com/cmspengumuman/';
		$params->lib['class_name'] = 'comcmspengumuman';
		$params->lib['header_caption'] = 'Pengaturan Konten &raquo; Konten Umum &raquo; Pengumuman';
		// =========================================================
	...
	function form(){
		$id		= $this->CI->input->post('id_pengumuman');
		$this->content['oper']	= $this->CI->input->post('oper');
		$this->content['id_pengumuman']	= @$id?@$id:0;
	...
	function urut(){
		...
		$id_pengumuman = $this->CI->input->post('id_pengumuman');
		$urutan = $this->CI->input->post('urutan');
		$data = $this->CI->com_model->urutan($oper,$id_pengumuman,$urutan,$tanggal);
		return @$data;
	} 
}
?>