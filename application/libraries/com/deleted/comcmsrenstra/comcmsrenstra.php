...
class Comcmsrenstra extends Grid {
	function __construct(){
	    // ===============================
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'admin/com/cmsrenstra/';
		$params->lib['class_name'] = 'comcmsrenstra';
		$params->lib['header_caption'] = 'Pengaturan Konten &raquo; Konten Khusus &raquo; Renstra';
		// =========================================================
	...
	function form(){
		$id		= $this->CI->input->post('id_renstra');
		$this->content['oper']	= $this->CI->input->post('oper');
		$this->content['id_renstra']	= @$id?@$id:0;
	...
	function urut(){
		...
		$id_renstra = $this->CI->input->post('id_renstra');
		$urutan = $this->CI->input->post('urutan');
		$data = $this->CI->com_model->urutan($oper,$id_renstra,$urutan,$tanggal);
		return $data;
	}
}
?>