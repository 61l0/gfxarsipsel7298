...
class Commstkdkomponen extends Grid{
	function __construct(){
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'admin/com/mstkdkomponen/';
		$params->lib['class_name'] = 'commstkdkomponen';
		$params->lib['header_caption'] = 'Data Master &raquo; Kode Komponen';
		// =========================================================
