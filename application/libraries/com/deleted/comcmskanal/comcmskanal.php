...
class Comcmskanal extends Grid {
	function __construct(){
	    // ===============================
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'cms/com/cmskanal/';
		$params->lib['class_name'] = 'comcmskanal';
		$params->lib['header_caption'] = 'Pengaturan Kanal &raquo; Kanal Manager';
		// =========================================================
