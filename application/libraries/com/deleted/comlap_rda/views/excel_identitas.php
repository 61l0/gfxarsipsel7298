<html>
<head>
	<title>LAPORAN REKAPITULASI DATA ARSIP / IDENTITAS ARSIP - TAHUN : <?php echo $tahun?$tahun:'ALL'?></title>
...
<body>
	...
	<table border="1" align="center" class="tb-excel" cellpadding="4" colspacing="4" style="border-collapse:collapse" width="98%">
		<thead>
			<tr>
				<th colspan="8" style="border:none;font-weight:bold;text-align:center;font-size:18px;valign:vcenter">KANTOR ARSIP DAERAH KOTA TANGERANG SELATAN</th>
			</tr>
			<tr>
			...
			<tr>
				<th  style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">LOKASI </th>
				<th colspan="7" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">
