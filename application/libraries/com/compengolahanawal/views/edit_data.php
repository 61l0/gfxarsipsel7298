...
<input type='hidden' name='id_depo' id='id_depo' value='<?=@$lokasi_simpan[0]->id_lokasi_simpan?>'>
<input type='hidden' name='id_rak' id='id_rak' value='<?=@$lokasi_simpan[1]->id_lokasi_simpan?>'>
<input type='hidden' name='id_box' id='id_box' value='<?=@$lokasi_simpan[2]->id_lokasi_simpan?>'>
<input type='hidden' name='id_folder' id='id_folder' value='<?=@$lokasi_simpan[3]->id_lokasi_simpan?>'>
<input type='hidden' name='id_rool' id='id_rool' value='<?=@$lokasi_simpan[1]->id_lokasi_simpan?>'>
	<table border=0 class="table-flat">
		...
		<tr>
			<td>Tanggal</td>
			<td>:</td>
			<td colspan=10><input type='text' name='tanggal' id='tanggal' value='<?=@$data_edit[0]->tgl_input?>'></td>
		</tr>	
		...
		<tr>
			<td>Keterangan</td>
			<td>:</td>
			<td colspan=10><textarea cols=40 rows=4 name='keterangan' id='keterangan' ><?=@$data_edit[0]->desc?></textarea></td>
		</tr>	
				
		<tr>
			<td>Type Penyimpanan</td>
			<td>:</td>
			<td colspan=10><input type='radio' name='rdpilih' id='rdpilih1' value='rak' <? if(@$lokasi_simpan[1]->type == 'rak' || @$lokasi_simpan[1]->type == ''){ ?>checked="checked" <? } ?>>Rak<input type='radio' name='rdpilih' id='rdpilih2'  value='rool' <? if(@$lokasi_simpan[1]->type == 'rool' || @$lokasi_simpan[1]->type == ''){ ?>checked="checked" <? } ?>>Rool O'Peek</td>
		</tr>
		<tr>
