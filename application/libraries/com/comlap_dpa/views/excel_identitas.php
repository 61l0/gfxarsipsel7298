<html>
<head>
	<title>LAPORAN DAFTAR PENCARIAN ARSIP IDENTITAS :  TAHUN : <?php echo $tahun?$tahun:'ALL'?></title>
...
<body>
	...
	<table border="1" align="center" class="tb-excel" cellpadding="4" colspacing="4" style="border-collapse:collapse" width="98%">
		<thead>
			<tr>
				<th colspan="14" style="border:none;font-weight:bold;text-align:center;font-size:18px;valign:vcenter">KANTOR ARSIP DAERAH KOTA TANGERANG SELATAN</th>
			</tr>
			<tr>
				<th colspan="14" style="border:none;font-weight:bold;text-align:center;font-size:14px;valign:vcenter">DAFTAR PENCARIAN ARSIP / IDENTITAS ARSIP</th>
			</tr>
			<tr>
				<th colspan="14" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter"> </th>
			</tr>
			<tr>
				<th colspan="2" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">DEPO </th>
			...
			<?php if(!empty($lokasi)){?>
			<tr>
				<th colspan="2" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">LOKASI </th>
				<th colspan="12" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">
				: <?php echo $lokasi?$lokasi:'ALL'?>
				</th>
			</tr>
			<?php } ?>
			<tr>
			...
			<?php if($klasifikasi_text != 'ALL'){?>
			<tr>
				<th colspan="2" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">KODE KLASIFIKASI </th>
				<th colspan="12" style="border:none;font-weight:bold;text-align:left;font-size:10px;valign:vcenter">
				: <?php echo $klasifikasi_text != 'ALL' ? str_replace(' - ',' / ',$klasifikasi_text) : 'ALL'?>
				</th>
			</tr>
			<?php } ?>
			<?php if($unit_pengolah_text != 'ALL'){?>
			<tr>
		...
		<tbody>
			<?php $count = count($dpa_list); $i = 0; ?>
			<?php foreach($dpa_list as $r):?>
			<?php ++$i?>
			<?php $is_last = ($i==$count) ;?>
			<tr>
