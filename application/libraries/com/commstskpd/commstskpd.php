...
class Commstskpd extends Grid {
	function __construct(){
	    // ===============================
		$this->CI = & get_instance();
		$params = new stdClass;
		$params->lib['com_url'] = 'admin/com/mstskpd/';
		$params->lib['class_name'] = 'commstskpd';
		$params->lib['header_caption'] = 'Master SKPD';
		// =========================================================
	...
	function comjs_features($params=false){
		...
		$this->content['comjs_features']['comjs_extra'] = $this->CI->load->com('commstskpd','view',$conf_view_features);
