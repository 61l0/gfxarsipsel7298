<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		var fnNameSv = "view({id_header:'"+cl+"'});";
		...
		var fnName3 = "<?=$class_name;?>grid.btn_grid_edit({id_header:"+cl+",oper:'edit'});";
		...
		var fnDel = "<?=$class_name;?>grid.extra.del({id_header:"+cl+"});";
		...
		var fnR = "<?=$class_name;?>grid.extra.refresh("+cl+");";
		var ref = jQuery("<span />").addClass("ui-icon ui-icon-refresh").attr('onclick',fnR);
