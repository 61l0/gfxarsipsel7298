<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		var fnNameSv = "<?=$class_name;?>grid.btn_grid_view({id_peraturan_perundangan:'"+cl+"'});";
		...
		var fnName3 = "<?=$class_name;?>grid.btn_grid_edit({id_peraturan_perundangan:"+cl+",oper:'edit'});";
		...
		var fnref = "<?=$class_name;?>grid.extra.refresh({id_peraturan_perundangan:"+cl+",status:'"+row.status+"'});";
		...
		var fnDel = "<?=$class_name;?>grid.extra.del({id_peraturan_perundangan:"+cl+"});";
