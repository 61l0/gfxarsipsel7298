<h3 class="grid-title"><i class="fa icon-tasks"></i>&nbsp;LAPORAN REKAPITULASI DATA ARSIP / KODE KLASIFIKASI DAN TAHUN ARSIP</h3>
...
<div class="toolbar-filter form">
	...
	<div>
		<form id="myForm" action="<?=site_url('admin/com/laporan_klasifikasi_tahun');?>/rptklasifikasi/" target="_blank" method="post">
