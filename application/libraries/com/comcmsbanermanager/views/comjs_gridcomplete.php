<?=$class_name;?>grid.opt.gridComplete = function(){
	...
	for(var i=0;i < ids.length;i++){
		...
		var fnNameSv = "<?=$class_name;?>grid.btn_grid_view({id_banner:'"+cl+"'});";
		...
		var fnName3 = "<?=$class_name;?>grid.btn_grid_edit({id_banner:"+cl+",oper:'edit'});";
		...
		var fnDel = "<?=$class_name;?>grid.extra.del({id_banner:"+cl+"});";
