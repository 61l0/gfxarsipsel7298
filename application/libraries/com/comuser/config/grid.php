...
$config['gridlib']['arr_colModel']["id_unit_pengolah"] = array(
	...
	'editable'=>true,
	'width'=>60,
	'formoptions'=>array('elmsuffix'=>"<input class=\"FormElement ui-widget-content ui-corner-all\" id=\"txt_pengolah\"/><button  id=btn_operator onclick=comusergrid.extra.pilihskpd({name:'commstoperator'})>Pilih</button>",
			'label'=>'Instansi/SKPD'),
	'edittype'=>'text',
