...
<h3 class="grid-title"><i class="fa icon-tasks"></i>&nbsp;Laporan Surat Masuk</h3>
...
<div class="toolbar-filter form">
	...
	<div>
	<form id="myForm" action="<?=site_url('admin/com/lap_surat_masuk');?>/rptsuratmasuk/" target="_blank" method="post">
