...
class Myexcel_dpa_klasifikasi extends PHPExcel {
    ...
    function Myexcel_dpa_klasifikasi()
    {
		parent::__construct();
    }
	...
	function download()
    {
		...
		header('Content-Disposition: attachment;filename="laporan_dpa_klasifikasi.xls"');
