...
class Myexcel_pelayanan_bulanan extends PHPExcel {
    ...
    function Myexcel_pelayanan_bulanan()
    {
		parent::__construct();
    }
	...
	function download()
    {
		...
		header('Content-Disposition: attachment;filename="laporan_pelayanan_bulanan.xls"');
